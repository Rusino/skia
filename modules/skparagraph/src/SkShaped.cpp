...
void ShapedParagraph::addWord(const char* startWord, const char* endWord, SkPoint point, SkVector advance, SkScalar baseline)
{
...
void ShapedParagraph::addLine(const char* start, const char* end, SkPoint point, SkVector advance, size_t lineIndex, bool lastLine)
{
