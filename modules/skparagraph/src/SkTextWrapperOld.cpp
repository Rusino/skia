...
bool SkTextWrapperOld::addLineUpToTheLastBreak() {
    ...
    auto& line = fParent->addLine(
            ...
            SkVector::Make(SkTMin(fLastSoftLineBreak.trimmedWidth(), fMaxWidth),
...
SkScalar SkTextWrapperOld::lengthUntilSoftLineBreak(SkCluster* cluster) {
    TRACE_EVENT0("skia", TRACE_FUNC);
    SkScalar length = 0;
...
void SkTextWrapperOld::formatText(SkSpan<SkCluster> clusters,
                               SkScalar maxWidth,
                               size_t maxLines,
