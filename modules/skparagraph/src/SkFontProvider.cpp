...
// Return a canonicalized version of a family name that is suitable for matching.
std::string SkFontProvider::CanonicalFamilyName(const std::string& family_name) {
